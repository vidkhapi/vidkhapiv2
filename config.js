export const SOURCES = [
    ...
    { key: 'icefy', sourceFile: 'icefy', label: 'Icefy', proxyParam: 'iy', timeout: 20000, jitter: 500, retries: 2, sourcesTimeout: 10000, disabled: true },
    { key: 'vidrock', sourceFile: 'vidrock', label: 'VidRock', proxyParam: 'vr', timeout: 20000, jitter: 800, retries: 3, disabled: true },
    ...
    { key: 'vixsrc', label: 'VixSrc', sourceFile: 'vixsrc', proxyParam: 'vx', timeout: 35000, retries: 2, jitter: 0, skipProxy: false, disabled: true },
    ...
    { key: 'movsrc', sourceFile: 'movsrc', label: 'MovSrc', proxyParam: 'ms', timeout: 20000, jitter: 500, retries: 2, disabled: true },
    { key: 'dulo', sourceFile: 'dulo', label: 'Dulo', proxyParam: 'dl', timeout: 20000, jitter: 500, retries: 2, disabled: true },
    { key: 'fireflix', sourceFile: 'fireflix', label: 'FireFlix', proxyParam: 'ff', timeout: 30000, jitter: 500, retries: 2, disabled: true },
    { key: 'watchott', sourceFile: 'watchott', label: 'WatchOtt', proxyParam: 'wo', timeout: 30000, jitter: 500, retries: 2, disabled: true },
