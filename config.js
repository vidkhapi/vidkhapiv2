export const SOURCES = [
    ...
    { key: 'popr', sourceFile: 'popr', label: 'Popr', proxyParam: 'pp', timeout: 20000, jitter: 600, retries: 2, disabled: false },
    { key: 'tulnex', sourceFile: 'tulnex', label: 'Tulnex', proxyParam: 'tn', timeout: 60000, jitter: 500, retries: 2 },
    { key: 'vidfun', sourceFile: 'vidfun', label: 'VidFun', proxyParam: 'vf', timeout: 20000, jitter: 500, retries: 2, disabled: false },
